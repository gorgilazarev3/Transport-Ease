...
import 'package:transportease_providers/Models/transporting_provider_info_model.dart';
export 'package:transportease_providers/Models/transporting_provider_info_model.dart';

class TransportProviderInformationWidget extends StatefulWidget {
  const TransportProviderInformationWidget({Key? key}) : super(key: key);

  @override
  _TransportProviderInformationWidgetState createState() =>
      _TransportProviderInformationWidgetState();
}

class _TransportProviderInformationWidgetState
    extends State<TransportProviderInformationWidget>
    with TickerProviderStateMixin {
  late TransportProviderInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransportProviderInformationModel());
    ...
    _model.carrierCapacityController ??= TextEditingController();
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(
                                                                0, 4, 0, 24),
                                                    child: Text(
                                                      'Ве молиме изберете тип на превозник и внесете ги потребните информации',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                        ...
                                                        child: Align(
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (val) =>
                                                                setState(() {}),
                                                            controller: _model
                                                                    .transportingTypeValueController ??=
                                                                FormFieldController<
                                                                        String>(
                                                                    null),
                                                            optionHeight: 32,
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            keyboardType:
                                                                TextInputType
                                                                    .number,
                                                            validator: _model
                                                                .carrierCapacityControllerValidator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
  ...
  bool validateFields(BuildContext context) {
    ...
    if (_model.providerTypeValue == null || _model.providerTypeValue!.isEmpty) {
      Fluttertoast.showToast(msg: "Мора да изберете тип на превозник!");
    } else {
      if (_model.providerTypeValue!.toLowerCase() == "превоз на патници") {
        if (_model.transportingTypeValue == null ||
            _model.transportingTypeValue!.isEmpty) {
          Fluttertoast.showToast(
              msg:
                  "Мора да изберете или меѓуградски или интернационален превозник!");
      ...
      } else if (_model.providerTypeValue!.toLowerCase() ==
          "превоз на пакети") {
        if (_model.carrierCapacityController.text.isEmpty) {
          Fluttertoast.showToast(
              msg:
                  "Мора да го внесете капацитетот на возилото за пренос на пакети!");
        } else {
          result = true;
        }
      }
